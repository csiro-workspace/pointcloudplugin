...
DEFINE_WORKSPACE_DATA_FACTORY(CSIRO::PointCloud::PclMeshModelInterfaceXYZ,
                              CSIRO::PointCloud::PointCloudPlugin::getInstance())
DEFINE_WORKSPACE_DATA_FACTORY(pcl::PointXYZ,
                              CSIRO::PointCloud::PointCloudPlugin::getInstance())
DEFINE_WORKSPACE_DATA_FACTORY(pcl::PointXYZRGBNormal,
                              CSIRO::PointCloud::PointCloudPlugin::getInstance())
